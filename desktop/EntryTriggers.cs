...
namespace AABattle {
 ...
 public static class TrainerTriggers {
  ...
  public static void Fire(TrainerRecord trainer,string label,string context,Action<string> log){foreach(var p in Matching(trainer,label))log("TRAINER 『"+p.name+"』 "+label+" 트리거 충족 · "+context+" · 효과 판정 대기: "+p.effect);}
