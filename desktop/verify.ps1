...
if ($Visual) {
    ...
    Invoke-BuildCheck 'AABattle.exe' @('--render-preview','outputs/verify/battle.png')
...
if ($Visual) { Write-Output "Screenshots: $checkDirectory/battle.png, catalog.png.moves.png and catalog.png.potentials.png" }
