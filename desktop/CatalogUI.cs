...
namespace AABattle {
 ...
 partial class DataEditorForm {
  ...
  public void TestCatalogUi(){
   if(tabs.TabPages[4].Text!="기술 도감"||tabs.TabPages[5].Text!="포텐셜 도감"||triggerKind==null||triggerKind.Items.Count!=8||effectKind==null)throw new Exception("Structured trigger and effect UI missing");
