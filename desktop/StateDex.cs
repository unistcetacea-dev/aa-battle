...
namespace AABattle {
 ...
 public static class StateDex {
  public static List<StateDexEntry> Entries(){
   ...
   Add(result,"포텐셜 수치 효과","구조화된 수치 입력","포텐셜 도감에서 효과를 고르는 자리에서 대상, 강화·약화, 배율을 직접 정합니다. 1.33을 입력하면 1.33배, 0.67을 입력하면 0.67배로 저장됩니다. 능력 랭크 상승은 오른다(+1), 크게 오른다(+2), 매우 크게 오른다(+3) 중에서 선택합니다.");
